...
tooltip_56 = '<optional, list of present specific markers to use for spot detection>: \nexample -> DO1,DO2'
...
tooltip_64 = '<optional, list of present specific markers to preprocess>: \nexample -> DAPI,CTNNB1,AMY2A,SST'
...
column = [[sg.Text('PIPEX data folder:', font='any 12'), sg.In(default_text=data_folder, size=(50,1), key='-DATA_FOLDER-'), sg.FolderBrowse(initial_folder=data_folder)],
          ...
          [sg.Text('  - Preprocessing markers, comma-separated:',s=(35,1), pad=((20,0), (0,0))), sg.Input(default_text='',s=40,disabled=True, key='-PREPROCESS_MARKER-'), sg.Image(data=info_icon,subsample=3,tooltip=tooltip_64)],
